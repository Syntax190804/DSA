...
{
System.out.println(" File Not found ExceptionOccured...");
}
}
//*********search**********
...
PrintWriter pw = new PrintWriter(new
BufferedWriter(new
FileWriter("studentRecordstemp.txt",true)));
String sId;
int flag=0;
...
{
PrintWriter pw=new PrintWriter(new
BufferedWriter(new FileWriter("studentRecords.txt")));
pw.close();
